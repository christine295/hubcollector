  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-sm p-8">
        ...
        <div className="opacity-60 select-none pointer-events-none space-y-4">
          <div>
          ...
          <button
            type="button"
            disabled
            className="w-full bg-blue-600 disabled:opacity-50 text-white rounded-lg px-4 py-2.5 text-sm font-medium"
          >
            Sign in
          </button>
        </div>
        <p className="text-xs text-gray-400 text-center mt-2">Email login coming soon — use Google for now</p>
